import { findElementBySelector, getDrillDownSelector } from '@univer-clipsheet-core/scraping';
    ...
    private _observer = new MutationObserver((mutations) => {
        ...
        mutations.forEach((mutation) => {
            ...
            mutation.addedNodes.forEach((node) => {
                ...
                // const selectors = [getDrillDownSelector(node), getDrillDownSelector(node, true)];
                // const elementInfo = _elementInfos.find((info) => selectors.includes(info.selector));
