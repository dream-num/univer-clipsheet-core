...
import { captureEvent, ClipsheetMessageTypeEnum, generateRandomId, UIStorageKeyEnum } from '@univer-clipsheet-core/shared';
...
import { AccurateExtractionController, ViewState } from '../table-scraping';
...
function disposeAccurateExtraction(injector: Injector) {
    ...
    elementInspectService.controller.deactivate();
...
export const AccurateExtractionDialog = (props: {
    ...
    const handleReselect = () => {
        ...
        elementInspectService.controller.activate();
    ...
    return (
        <ReactDraggable axis="both" onStart={() => elementInspectService.controller.activate()} onStop={() => elementInspectService.controller.deactivate()}>
