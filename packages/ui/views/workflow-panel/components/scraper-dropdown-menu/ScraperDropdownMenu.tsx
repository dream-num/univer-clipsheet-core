...
// import { SearchInput } from '@chrome-extension-boilerplate/shared-client';
// import { getActiveTab, type IScraper, MsgType, openSidePanel, StorageKeys, throttle } from '@chrome-extension-boilerplate/shared';
...
import { ClipsheetMessageTypeEnum, getActiveTab, openSidePanel, throttle, UIStorageKeyEnum } from '@univer-clipsheet-core/shared';
...
export const ScraperDropdownMenu = (props: IScraperDropdownMenuProps) => {
    ...
    return (
        <Tooltip showArrow={false} overlayClassName="white-tooltip" placement="bottomRight" trigger="click" visible={visible} onVisibleChange={setVisible} overlay={overlay}>
            {children}
        </Tooltip>
    );
};
